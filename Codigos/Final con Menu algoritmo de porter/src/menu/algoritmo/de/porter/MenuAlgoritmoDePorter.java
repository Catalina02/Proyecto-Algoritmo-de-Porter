...
public class MenuAlgoritmoDePorter {
  ...
  private static final String SIGNOS="\\p{Punct}";//eliminar signos de puntuacion
    ...
    private static final String  DO1 =  ","+PALABRA;
    private static final String  DO2 =  "-|¿|¡|!|/|–"+PALABRA;
    private static final String  DO3 =  ESPACIO+"-|–"+ESPACIO;
    private static final String  DO4 =  ESPACIO+"no"+ESPACIO;
    private static final String  DO5 =  ESPACIO+"mo"+ESPACIO;
    private static final String  DO6 =  ESPACIO+"cab"+ESPACIO;
    private static final String  DO7 =  ESPACIO+"l"+ESPACIO;
    private static final String  DO8 =  ESPACIO+"che"+ESPACIO;
    private static final String  DO9 =  ESPACIO+"e"+ESPACIO;
    private static final String  DO10 =  ESPACIO+"a"+ESPACIO;
    private static final String  DO11 =  ESPACIO+"c"+ESPACIO;
    private static final String  DO12 =  ESPACIO+"ma"+ESPACIO;
     private static final String  DO13 =  ESPACIO+"f"+ESPACIO;
    private static final String  DO14 =  ESPACIO+"v"+ESPACIO;
...
//Prejijos
  ...
  private static final String PREF1= ESPACIO+"(an)"+PALABRA;
  ...
  private static final String PREF7= ESPACIO+"(des|de|del)"+PALABRA;
  ...
  private static final String ART8= ESPACIO+"(a|al)"+ESPACIO;
  private static final String ART10= ESPACIO+"\\n"+ESPACIO;
  private static final String ART11= ESPACIO+"(o|por|que)"+ESPACIO;
  private static final String ART12= ESPACIO+"(su|u)"+ESPACIO;
...
//eliminar s
  ...
  return cadena.replaceAll("\n", ""); 
     ...
     public String Eli(String Texto)
  {
        Matcher coincidencia;
        Pattern elimtilde;
        elimtilde = Pattern.compile(DO1);
        coincidencia=elimtilde.matcher(Texto);
        Texto=coincidencia.replaceAll("");
        elimtilde = Pattern.compile(DO);
        coincidencia=elimtilde.matcher(Texto);
        Texto=coincidencia.replaceAll("");
     ...
     public String ElimPro(String Texto)
  {
      Pattern epron;
      Matcher coincidencia;
      
      epron= Pattern.compile(DO3);
      ...
      coincidencia=epron.matcher(Texto);
      Texto=coincidencia.replaceAll("");
      epron= Pattern.compile(DO4);
      coincidencia=epron.matcher(Texto);
      Texto=coincidencia.replaceAll("");
      epron= Pattern.compile(DO5);
      coincidencia=epron.matcher(Texto);
      Texto=coincidencia.replaceAll("");
      epron= Pattern.compile(DO6);
      coincidencia=epron.matcher(Texto);
      Texto=coincidencia.replaceAll("");
      epron= Pattern.compile(DO7);
      coincidencia=epron.matcher(Texto);
      Texto=coincidencia.replaceAll("");
      epron= Pattern.compile(DO8);
      coincidencia=epron.matcher(Texto);
      Texto=coincidencia.replaceAll("");
      epron= Pattern.compile(DO9);
      coincidencia=epron.matcher(Texto);
      Texto=coincidencia.replaceAll("");
      epron= Pattern.compile(DO10);
      coincidencia=epron.matcher(Texto);
      Texto=coincidencia.replaceAll("");
      epron= Pattern.compile(DO11);
      coincidencia=epron.matcher(Texto);
      Texto=coincidencia.replaceAll("");
      epron= Pattern.compile(DO12);
      coincidencia=epron.matcher(Texto);
      Texto=coincidencia.replaceAll("");
       epron= Pattern.compile(DO13);
      coincidencia=epron.matcher(Texto);
      Texto=coincidencia.replaceAll("");
       epron= Pattern.compile(DO14);
      coincidencia=epron.matcher(Texto);
      Texto=coincidencia.replaceAll("");
  ...
  public String ElimTildes(String Texto)
  {
        ...
        elimtilde = Pattern.compile(DO2);
        coincidencia=elimtilde.matcher(Texto);
        Texto=coincidencia.replaceAll("");
        elimtilde = Pattern.compile(DO3);
        coincidencia=elimtilde.matcher(Texto);
        Texto=coincidencia.replaceAll("");
  ...
  public String ElimArticulos(String Texto)
  {
      ...
      eart=Pattern.compile(ART8);
      coincidencia=eart.matcher(Texto);
      Texto=coincidencia.replaceAll("");
      
      eart=Pattern.compile(ART10);
      coincidencia=eart.matcher(Texto);
      Texto=coincidencia.replaceAll("");
      eart=Pattern.compile(ART11);
      coincidencia=eart.matcher(Texto);
      Texto=coincidencia.replaceAll("");
      eart=Pattern.compile(ART12);
      coincidencia=eart.matcher(Texto);
      Texto=coincidencia.replaceAll("");
